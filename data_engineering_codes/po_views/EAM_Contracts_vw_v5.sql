-- ============================================================
-- Edw_Eam.Contracts_vw  v5  -  Added Date_Anomaly_Flag
--
...
SELECT
    ...
    -- Data quality flag: 1 = source data anomaly (approval after due date)
    -- Typically caused by migration backdating or expired contracts never updated
    CASE WHEN [Purchase_Order_Approv] > [Purchase_Order_Due_Date]
         THEN 1 ELSE 0
