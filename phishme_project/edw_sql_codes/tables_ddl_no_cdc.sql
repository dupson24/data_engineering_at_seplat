...
-- Staging Tables DDL — zzSTG_phishme_security  (NO CDC COLS)
-- Target Tables DDL — phishme_security
-- Database : seplat_edw
-- Author   : Data Engineering
-- Date     : 2026-03-13
-- Notes    : CDC columns removed from staging — UPSERT pattern
--            Staging exact column match to parquet source
-- ============================================================
...
PRINT 'CDC columns removed from staging'
